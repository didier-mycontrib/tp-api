...
function postNewDeviseWithAjax(nouvelleDevise){
    ...
    makeAjaxPostRequest( "../tp/devise-api/v1/public/devises" ,
...
function putNewValueOfExistingDeviseWithAjax(deviseToUpdate){
    makeAjaxPutRequest("../tp/devise-api/v1/public/devises/"+deviseToUpdate.code+"?v=true" ,
...
function deleteOldDeviseWithAjax(oldDevise){
    ...
    //***************************************
    let deleteUrl= "../tp/devise-api/v1/public/devises/" + oldDevise.code + "?v=true"
