...
import { deviseClassicSubTestGroup } from './devise-api.test.js'
import { productClassicSubTestGroup } from './product-api.test.js'
...
firstLevelTestWithTestContainer(
    [deviseClassicSubTestGroup(),
     productClassicSubTestGroup(),
